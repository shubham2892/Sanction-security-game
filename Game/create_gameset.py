...
def create_game_set(player_ids):
    ...
    game_1 = Game.objects.create(total_ticks=40, manager_sanc=INDIVIDUAL_SANC, attack_frequency=30)
    game_2 = Game.objects.create(total_ticks=40, manager_sanc=INDIVIDUAL_SANC, attack_frequency=30)
    game_3 = Game.objects.create(total_ticks=40, manager_sanc=GROUP_SANC, attack_frequency=30)
    game_4 = Game.objects.create(total_ticks=40, manager_sanc=GROUP_SANC, attack_frequency=30)
