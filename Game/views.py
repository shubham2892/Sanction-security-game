...
class GameFlowView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['game_key_1'] = str(game_set.game_1.game_key)
        context['game_key_2'] = str(game_set.game_2.game_key)
        context['game_key_3'] = str(game_set.game_3.game_key)
        context['game_key_4'] = str(game_set.game_4.game_key)
